  ...
  return (
    <div style={{ padding: '32px 24px', maxWidth: 900, margin: '0 auto' }}>
      <div style={{ marginBottom: 28 }}>
        <h1 style={{ color: '#f8fafc', fontSize: 20, fontWeight: 700, margin: 0 }}>Mensajes</h1>
        <p style={{ color: '#64748b', fontSize: 13, marginTop: 4 }}>WhatsApp y Email</p>
      </div>

      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16 }}>
        {/* WhatsApp */}
        <div style={{ background: '#0a0f1f', border: '1px solid #1e293b', borderRadius: 12, padding: 24 }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 16 }}>
            <div style={{
              width: 40, height: 40, borderRadius: 10, background: '#25d3661a',
        ...
        <div style={{ background: '#0a0f1f', border: '1px solid #1e293b', borderRadius: 12, padding: 24 }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 16 }}>
            <div style={{
              width: 40, height: 40, borderRadius: 10, background: '#6366f11a',
              display: 'flex', alignItems: 'center', justifyContent: 'center',
            }}>
